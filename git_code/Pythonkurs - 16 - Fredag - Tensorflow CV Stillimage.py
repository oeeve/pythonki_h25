...
# Load the model
model = load_model("../git_data/image_video/converted_keras/keras_model.h5", custom_objects=custom_objects, compile=False)

# Load the labels
class_names = open("../git_data/image_video/converted_keras/labels.txt", "r").readlines()
...
images, imagenames = stillimages('../git_data/image_video/fruits_test')
i = 0
for image in images:
